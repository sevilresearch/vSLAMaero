...
fdi_start_time_1_airs=45; %500;                               %Start of fault (sec)
fdi_duration_1_airs=55; %1000;                                 %Duration of fault (sec) for no fault in this sensor> duration=0
...
fdi_fault_value_2_airs=3; %beta0*0.1;                                %value of fault, f2
fdi_start_time_2_airs=500; %0; %200;                               %Start of fault (sec)
fdi_duration_2_airs=1000;                                 %Duration of fault (sec) for no fault in this sensor> duration=0
